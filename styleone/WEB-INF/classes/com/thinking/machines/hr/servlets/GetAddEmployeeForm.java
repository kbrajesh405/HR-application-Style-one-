...
public class GetAddEmployeeForm extends HttpServlet
{
...
pw.println("<h3>Employees (Add Module)</h3><br>");
pw.println("<table>");
pw.println("<form method='post' action='/styleone/addEmployee' onsubmit='return formValidation(this)'>");
pw.println("<tr>");
pw.println("<td>Name</td> ");
pw.println("<td><input type='text' id='name' name='name' maxlength='50'> <span id='nameErrorSection' style='color:red;'></span></td>");
pw.println("</tr>");
pw.println("");
pw.println("<tr>");
...
pw.println("<td><input type='date' id='dateOfBirth' name='dateOfBirth' value='1970-01-01'> <span id='dateOfBirthErrorSection' style='color:red;'></span></td>");
pw.println("</tr>");
pw.println("");
pw.println("<tr>");
...
pw.println("<td><input type='text' id='basicSalary' name='basicSalary' style='text-align:right'> <span id='basicSalaryErrorSection' style='color:red;'></span></td>");
pw.println("</tr>");
pw.println("");
pw.println("<tr>");
pw.println("<td>PAN Card Number</td> ");
pw.println("<td><input type='text' id='panCardNumber' name='panCardNumber' maxlength='15'> <span id='panCardNumberErrorSection' style='color:red;'></span></td>");
pw.println("</tr>");
pw.println("");
pw.println("<tr>");
pw.println("<td>Aadhar Card Number</td> ");
pw.println("<td><input type='text' id='aadharCardNumber' name='aadharCardNumber' maxlength='15'> <span id='aadharCardNumberErrorSection' style='color:red;'></span></td>");
pw.println("</tr>");
pw.println("");
pw.println("<tr>");
pw.println("<td></td> ");
...
pw.println("");
pw.println("<tr>");
pw.println("<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <button type='submit'>Add</button></td>");
